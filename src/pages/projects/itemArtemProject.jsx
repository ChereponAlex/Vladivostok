...
const ItemArtemProject = () => {
    ...
    switch (projectID) {
        case '1':
            return (
                <div className='background_artem_project_1'>
                    <div className='btn_back_container' >
                        <div className='btn_back_cluster' onClick={() => navigate('/cluster/6')}>
        ...
        case '2':
            return (
                <div className='background_artem_project_2'>
                    <div className='btn_back_container' >
                        <div className='btn_back_cluster' onClick={() => navigate('/cluster/6')}>
                            <Back_btn className='header_icons' />
                        </div>
        ...
        case '3':
            return (
                <div className='background_artem_project_3'>
                    <div className='btn_back_container' >
                        <div className='btn_back_cluster' onClick={() => navigate('/cluster/6')}>
                            <Back_btn className='header_icons' />
                        </div>
        ...
        case '4':
            return (
                <div className='background_artem_project_4'>
                    <div className='btn_back_container' >
                        <div className='btn_back_cluster' onClick={() => navigate('/cluster/6')}>
                            <Back_btn className='header_icons' />
                        </div>
...
export default ItemArtemProject;